  ...
  return (
    <aside className="hidden lg:block">
      <nav aria-label="Category directory" className="sticky top-32 overflow-hidden rounded-lg border border-retail-border bg-retail-card">
        <div className="flex items-center gap-2 border-b border-retail-border bg-retail-light-green px-4 py-3 text-sm font-bold text-retail-dark-green"><Grid2X2 className="h-4 w-4" />Browse Categories</div>

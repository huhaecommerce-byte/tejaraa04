...
const proofPoints = [
  { icon: Users, label: 'Grow with every seller you onboard' },
  { icon: LineChart, label: 'Track every commission in real time' },
  { icon: BadgeCheck, label: 'Lifetime earnings on repeat orders' },
];
    ...
    <div className="retail-theme min-h-[100dvh] bg-background text-foreground">
      <div className="grid min-h-[100dvh] lg:grid-cols-[minmax(0,0.92fr)_minmax(560px,1.08fr)]">
        <aside className="relative hidden min-h-[100dvh] overflow-hidden bg-retail-dark-green text-primary-foreground lg:block">
          <img
            src={agencyTeamImage}
            alt="Agency professionals and virtual assistants collaborating in Riyadh"
            width={1408}
            height={1024}
          ...
          <div className="relative z-10 flex min-h-[100dvh] flex-col p-10 xl:p-14">
            ...
            <div className="my-auto max-w-lg py-12">
              ...
              <h2 className="mt-6 font-display text-4xl font-extrabold leading-tight xl:text-5xl">
                Your network grows.<br />Your income grows with it.
              </h2>
              <p className="mt-5 max-w-md text-base leading-7 text-primary-foreground/80">
                Bring ambitious dropshippers to Tejaraa and earn from every order they place.
              </p>
            ...
            <p className="text-xs text-primary-foreground/65">© 2026 Tejaraa.com · Partners in shared growth</p>
          </div>
        </aside>
        ...
        <main className="flex min-h-[100dvh] flex-col bg-retail-page px-4 py-5 sm:px-8 lg:px-10 lg:py-8 xl:px-16">
          <div className="flex items-center justify-between lg:hidden">
            ...
            <Link to="/agency" aria-label="Back to agency programme" className="flex h-10 w-10 items-center justify-center rounded-md border border-retail-border bg-retail-card text-retail-dark-green">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-xs text-retail-muted">
            {['Free to join', 'Secure partner access', 'Paid in SAR'].map((item) => (

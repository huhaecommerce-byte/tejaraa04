...
export function moduleForRoute(pathname: string, tab: string | null): AdminModuleKey | null {
  ...
  if (pathname.startsWith('/agency-admin') || pathname.startsWith('/admin/agencies') || pathname.startsWith('/admin/agency-payouts') || pathname.startsWith('/admin/agency-settings')) return 'agencies';

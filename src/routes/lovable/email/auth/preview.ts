...
const SAMPLE_PROJECT_URL = "https://tejaraa.com"
const SAMPLE_CONFIRM_URL = "https://tejaraa.com/auth/confirm?token=sample-token"
...
const SAMPLE_DATA: Record<string, object> = {
  signup: {
    ...
    confirmationUrl: SAMPLE_CONFIRM_URL,
  },
  magiclink: {
    siteName: SITE_NAME,
    confirmationUrl: SAMPLE_CONFIRM_URL,

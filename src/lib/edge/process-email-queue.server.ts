import { sendResendEmail } from "@/lib/email-templates/resend.server"
...
export async function handler(
  ...
  // `trusted` means the route already authenticated the caller as the
  // scheduled job (cron bearer secret). Otherwise require a service-role JWT.
  if (!opts?.trusted) {

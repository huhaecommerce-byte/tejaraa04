...
const NotFound = () => {
  ...
  return (
    <RetailPublicShell>
      <SEO
        title="Page not found — Tejaraa"
        description="The page you are looking for doesn't exist or has moved. Browse categories or search products on Tejaraa."
      ...
      <main>
        <RetailContainer className="py-10 sm:py-16">
          <div className="mx-auto max-w-xl rounded-xl border border-retail-border bg-retail-card p-6 text-center sm:p-10">
            ...
            <h1 className="mt-1 text-2xl font-extrabold text-retail-text sm:text-3xl">We can't find that page</h1>
            <p className="mt-2 text-sm text-retail-muted">
              The page may have been moved or no longer exists. Try browsing our categories or searching for a product.
            </p>
